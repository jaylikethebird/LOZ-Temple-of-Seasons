...
@alreadyGaveRingBox:
	...
	jumpiftextoptioneq $00, @list
	jumpiftextoptioneq $01, @appraise
...
@npcLoop:
	...
	checkabutton
	disableinput
	showtextnonexitablelowindex <TX_3004
	jumpiftextoptioneq $00, @list
	jumpiftextoptioneq $01, @appraise
...
@npcLoop:
	...
	checkabutton
	disableinput
	showtextnonexitablelowindex <TX_3005
	jumpiftextoptioneq $00, @list
	jumpiftextoptioneq $01, @appraise

	; Selected "Quit"
	enableinput
	showtextlowindex <TX_3006
	scriptjump @npcLoop

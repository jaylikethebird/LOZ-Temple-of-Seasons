...
@givingDoll:
	wait 30
	showtext TX_0b1c
	giveitem TREASURE_X_SHAPED_JEWEL, $00
	orroomflag $40
	enableinput
@gaveDoll:
	checkabutton
...
@haveRingBox:
	...
	giveitem TREASURE_SWITCH_HOOK, $00
	wait 40
...
piratianCaptainScript_inHouse:
	initcollisions
	jumpifitemobtained TREASURE_X_SHAPED_JEWEL, @6thEssenceGotten
	checkabutton
...
jewelHelperScript_underwaterPyramidJewel:
	...
	.dw @linked
@unlinked:
	spawnitem TREASURE_TRADEITEM, $06
-
	jumpifitemobtained TREASURE_TRADEITEM, @end
	scriptjump -
@end:
	scriptend
@linked:
